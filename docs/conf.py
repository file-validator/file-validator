#!/usr/bin/env python
#
# file_validator documentation build configuration file, created by
...
version = file_validator.__version__
# The full version, including alpha/beta/rc tags.
release = file_validator.__version__
