...
def error_message(
    ...
    :param message: The error message to be shown to the user when the file is not valid, You can customize this message through the Django settings (settings.py), to display the file name in the error message, just put the string {file} in the error message you want, or to display the mimes that the file is based on To be validated, just put {mimes} in your error message
